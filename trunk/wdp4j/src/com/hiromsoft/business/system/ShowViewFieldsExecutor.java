...
public class ShowViewFieldsExecutor extends BaseBusinessExecutor {
...
//		最多复制100行
		...
		try{
			pst=dbsession.connection().prepareStatement("update sys_views_fields set display='1' where id=?");
